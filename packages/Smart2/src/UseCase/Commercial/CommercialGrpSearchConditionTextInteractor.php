...
class CommercialGrpSearchConditionTextInteractor
{
    ...
    /**
     * CommercialGrpSearchConditionTextInteractor constructor.
    ...
    public function handle(InputData $input): array
    {
        ...
        $header = $this->searchConditionTextAppService->getGrpHeader(...array_merge($params, [
            $codeList,
            $cnt,
            $tsCnt,
        ]));
